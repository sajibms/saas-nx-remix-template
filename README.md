...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/9GBcRYPUAX)
...
```sh
npx nx serve saas-one
```

To create a production bundle:

```sh
npx nx build saas-one
```

To see all available targets to run for a project, run:

```sh
npx nx show project saas-one
```
